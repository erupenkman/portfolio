		...
		<div id="navigation">
			<div id="menu">
				<ol> <!-- http://codex.wordpress.org/Conditional_Tags -->
					<li><a <?php if ( is_home() || is_category("work") ) { ?> class="active"<?php } ?> href="<?php echo get_option('home'); ?>/" title="Portfolio Examples">Work Examples<small>What I Can Do</small></a></li>

					<li><a <?php if ( is_page('about') ) { ?> class="active"<?php } ?> href="<?php echo get_option('home'); ?>/about" title="My Blog">Blog<small>Coming Soon..</small></a></li>

					<li id="menulast"><a <?php if ( is_page('contact-us') ) { ?> class="active"<?php } ?> href="<?php echo get_option('home'); ?>/contact-us" title="Contact Me">Contact<small>Let's Talk</small></a></li>
				</ol>
